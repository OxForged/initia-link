...
export default function QRButton({ username }: Props) {
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="btn-press bg-white border-2 border-[var(--card-border)] text-[#555] p-2.5 rounded-xl hover:border-[var(--accent)] hover:text-[var(--accent)] hover:scale-105 transition-all duration-300 min-h-[44px] min-w-[44px] inline-flex items-center justify-center"
        title="QR Code"
      >
