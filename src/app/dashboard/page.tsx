  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      <div className="animate-fade-in-up delay-5 mb-8">
        ...
        {tips.length === 0 ? (
          <div className="text-center py-6 bg-white rounded-2xl border border-[var(--card-border)]">
          ...
          <div className="space-y-2">
            {followingList.map((item, i) => (
              <a
                ...
                className="animate-fade-in-up flex items-center gap-3 bg-white border border-[var(--card-border)] rounded-xl px-4 py-3 hover:shadow-[0_4px_16px_rgba(8,145,178,0.1)] hover:-translate-y-0.5 transition-all duration-200"
                style={{ animationDelay: `${500 + i * 60}ms` }}
              >
                <span className="w-8 h-8 rounded-full gradient-accent flex items-center justify-center text-xs font-bold text-white shrink-0">
