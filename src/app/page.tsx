      ...
      <section className="pt-4 sm:pt-8 lg:pt-12 pb-8 lg:pb-16">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-12 items-center">
          ...
          <div className="flex-1 flex flex-col justify-center relative z-20 text-center lg:text-left">
            ...
            <p className="animate-fade-in-up delay-2 text-[#555] text-sm sm:text-base md:text-lg mb-8 max-w-xl leading-relaxed mx-auto lg:mx-0">
            ...
            <div className="animate-fade-in-up delay-3 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
              ...
              <a
                href="/discover"
                className="btn-press bg-white border border-[#d1e8ed] text-[#555] px-6 sm:px-8 py-3 sm:py-3.5 rounded-xl font-semibold hover:border-[var(--accent)] hover:text-[var(--accent)] transition-all duration-300 text-center text-sm"
              >
                Discover Profiles
              </a>
            </div>
          ...
          <div className="flex-shrink-0 flex justify-center relative w-full max-w-[360px]">
            ...
            {/* The profile card */}
            <div
              className="relative w-full bg-white/80 backdrop-blur-xl rounded-[2rem] p-2 animate-fade-in-up delay-4"
              style={{ boxShadow: '0 20px 40px -10px rgba(139,92,246,0.15), 0 0 20px 0px rgba(8,145,178,0.05)' }}
            >
              <div className="bg-white rounded-[1.75rem] p-5 sm:p-6 h-full" style={{ boxShadow: 'inset 0 1px 0 0 rgba(255,255,255,0.8), inset 0 0 0 1px rgba(255,255,255,0.4)' }}>

                {/* Cover banner */}
                <div className="h-24 sm:h-28 -mx-5 -mt-5 sm:-mx-6 sm:-mt-6 rounded-t-[1.75rem] relative overflow-hidden group/banner" style={{ background: 'linear-gradient(to right, #f0fdfa, #f5f3ff)' }}>
                ...
                <div className="relative flex justify-center -mt-14 sm:-mt-16 mb-3 group/avatar">
                  <div className="rounded-full p-[5px]" style={{ background: 'linear-gradient(135deg, #0891b2, #8b5cf6)', boxShadow: '0 8px 24px rgba(139,92,246,0.2)' }}>
                    <img
                      ...
                      alt="alice.init"
                      className="w-20 h-20 sm:w-24 sm:h-24 rounded-full border-4 border-white object-cover bg-white select-none pointer-events-none"
                      draggable="false"
                    />
                    <div className="absolute bottom-1.5 right-1.5 w-4 h-4 bg-green-400 border-2 border-white rounded-full" />
                  </div>
                ...
                {/* Stats */}
                <div className="grid grid-cols-2 gap-4 mb-5 p-3 rounded-2xl border border-white/40 group/stats relative" style={{ background: 'rgba(244,249,251,0.5)' }}>
                  ...
                  <div className="text-center border-r border-gray-200/50">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-[10px] font-bold uppercase tracking-widest text-[var(--muted)]">INIT Tipped</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2 group/links relative">
                  ...
                  {previewLinks.map((link) => {
                    ...
                    return (
                      <div
                        key={link.platformId}
                        className={`flex items-center gap-3 p-2.5 rounded-2xl bg-white border border-gray-100 shadow-sm ${link.hoverBorder} hover:shadow-md transition-all cursor-default`}
                      >
